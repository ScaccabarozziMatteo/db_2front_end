    ...
    function Logged() {
        return (
            <div style={{alignItems:'center'}}>
                <HorizontalLinearStepper checkInsolvent={props.checkInsolvent} setCheckInsolvent={props.setCheckInsolvent} setOrderId={props.setOrderId} role={props.role} reload={props.reload}/>
            </div>
        )
    }
