...
const FinalStepButton =(props)=>{
    ...
    return(
        isLoggedIn?
        <Button style={{position:"fixed", right:"0", bottom:"40%"}} variant="contained" endIcon={<SendIcon />} onClick={props.handleConfirm}>
            BUY
        </Button>
        :
    <div className="flexdiv" style={{position:"fixed", right:"0", bottom:"40%"}}>
