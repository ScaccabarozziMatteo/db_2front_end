                ...
                <React.Fragment>
                    <Box sx={{display: 'flex', flexDirection: 'row', pt: 2}}>
                        ...
                        {activeStep !== steps.length - 1 ?
                            ...
                            :
                            <FinalStepButton checkInsolvent={props.checkInsolvent}
                                             setCheckInsolvent={props.setCheckInsolvent} handleConfirm={handleConfirm}
                                             role={props.role} reload={props.reload}/>
                        }
                    </Box>
                    ...
                    {activeStep === 0 ?
                        <div className="selected">
                            <div className="packageDetails">
                                ...
                                <div className="dateSelector">
                                    Starting from:
                                    <DayPickerInput placeholder={today.toLocaleDateString()}
                        ...
                        activeStep === 1 ?
                            ...
                            <Riepilogo selectedPackage={JSON.parse(localStorage.getItem("selectedPackage"))}
                                       validity={localStorage.getItem("validity")}
